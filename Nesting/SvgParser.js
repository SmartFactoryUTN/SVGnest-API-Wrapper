...
export default class SvgParser{
    ...
    transformParse = function(transformString){
        var operations = {
            matrix: true,
            scale: true,
            rotate: true,
    ...
    applyTransform = function(element, globalTransform){
    ...
    filter = function(whitelist, element){
